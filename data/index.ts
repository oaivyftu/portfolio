...
export const projects: { [key: string]: Project} = {
  ...
  'nestscout': createApplicationProject({
    ...
    link: "https://example.com/nestscout",
    domain: "real estate",
  ...
  'finharbor': createApplicationProject({
    ...
    link: "https://example.com/finharbor",
    domain: "finance",
  ...
  'matchpulse': createApplicationProject({
    ...
    link: "https://example.com/matchpulse",
    domain: "sport",
  ...
  'skillnest': createApplicationProject({
    ...
    link: "https://example.com/skillnest",
    domain: "education",
  ...
  'caretrail': createApplicationProject({
    ...
    link: "https://example.com/caretrail",
    domain: "healthcare",
  ...
  'routeforge': createApplicationProject({
    ...
    link: "https://example.com/routeforge",
    domain: "logistics",
  ...
  'biteway': createApplicationProject({
    ...
    link: "https://example.com/biteway",
  ...
  'greengrid': createApplicationProject({
    ...
    link: "https://example.com/greengrid",
  ...
  'studiowave': createApplicationProject({
    ...
    link: "https://example.com/studiowave",
